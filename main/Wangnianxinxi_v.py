...
from .models import wangnianxinxi
...
def wangnianxinxi_register(request):
    if request.method in ["POST", "GET"]:
        msg = {'code': normal_code, "msg": mes.normal_code}
        req_dict = request.session.get("req_dict")


        error = wangnianxinxi.createbyreq(wangnianxinxi, wangnianxinxi, req_dict)
...
def wangnianxinxi_login(request):
    if request.method in ["POST", "GET"]:
        msg = {'code': normal_code, "msg": mes.normal_code}
        req_dict = request.session.get("req_dict")
        datas = wangnianxinxi.getbyparams(wangnianxinxi, wangnianxinxi, req_dict)
        if not datas:
        ...
        try:
            __sfsh__= wangnianxinxi.__sfsh__
        except:
            __sfsh__=None
        ...
        return Auth.authenticate(Auth, wangnianxinxi, req_dict)


def wangnianxinxi_logout(request):
    if request.method in ["POST", "GET"]:
        msg = {
            "msg": "登出成功",
            "code": 0
...
def wangnianxinxi_resetPass(request):
    '''
    '''
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code}
        ...
        columns=  wangnianxinxi.getallcolumn( wangnianxinxi, wangnianxinxi)

        try:
            __loginUserColumn__= wangnianxinxi.__loginUserColumn__
        except:
        ...
        records=wangnianxinxi.getbyparams(wangnianxinxi, wangnianxinxi, recordsParam)
        if len(records)<1:
            msg['code'] = 400
            msg['msg'] = '用户不存在'
            return JsonResponse(msg, encoder=CustomJsonEncoder)

        eval('''wangnianxinxi.objects.filter({}='{}').update({}='{}')'''.format(username_str,username,password_str,init_pwd))
        
        return JsonResponse(msg, encoder=CustomJsonEncoder)



def wangnianxinxi_session(request):
    '''
    '''
    if request.method in ["POST", "GET"]:
        ...
        msg['data']  = wangnianxinxi.getbyparams(wangnianxinxi, wangnianxinxi, req_dict)[0]

        return JsonResponse(msg, encoder=CustomJsonEncoder)


def wangnianxinxi_default(request):

    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code,"msg": mes.normal_code, "data": {}}
        req_dict = request.session.get("req_dict")
        req_dict.update({"isdefault":"是"})
        data=wangnianxinxi.getbyparams(wangnianxinxi, wangnianxinxi, req_dict)
        if len(data)>0:
            msg['data']  = data[0]
        else:
            msg['data']  = {}
...
def wangnianxinxi_page(request):
    '''
    '''
    if request.method in ["POST", "GET"]:
        ...
        global wangnianxinxi
        #当前登录用户信息
        tablename = request.session.get("tablename")

        msg['data']['list'], msg['data']['currPage'], msg['data']['totalPage'], msg['data']['total'], \
        msg['data']['pageSize']  =wangnianxinxi.page(wangnianxinxi, wangnianxinxi, req_dict, request)
        return JsonResponse(msg, encoder=CustomJsonEncoder)

def wangnianxinxi_autoSort(request):
    '''
...
主要信息列表（如商品列表，新闻列表）中使用，显示最近点击的或最新添加的5条记录就行
    ...
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code,  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        req_dict = request.session.get("req_dict")
        if "clicknum"  in wangnianxinxi.getallcolumn(wangnianxinxi,wangnianxinxi):
            req_dict['sort']='clicknum'
        elif "browseduration"  in wangnianxinxi.getallcolumn(wangnianxinxi,wangnianxinxi):
            req_dict['sort']='browseduration'
        else:
            req_dict['sort']='clicktime'
        req_dict['order']='desc'
        msg['data']['list'], msg['data']['currPage'], msg['data']['totalPage'], msg['data']['total'], \
        msg['data']['pageSize']  = wangnianxinxi.page(wangnianxinxi,wangnianxinxi, req_dict)

        return JsonResponse(msg, encoder=CustomJsonEncoder)

#分类列表
def wangnianxinxi_lists(request):
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code,  "data":[]}
        msg['data'],_,_,_,_  = wangnianxinxi.page(wangnianxinxi, wangnianxinxi, {})
        return JsonResponse(msg, encoder=CustomJsonEncoder)

def wangnianxinxi_query(request):
    '''
    '''
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        try:
            query_result = wangnianxinxi.objects.filter(**request.session.get("req_dict")).values()
...
def wangnianxinxi_list(request):
    '''
    前台分页
    '''
    if request.method in ["POST", "GET"]:
        ...
        try:
            __foreEndList__=wangnianxinxi.__foreEndList__
        except:
            __foreEndList__=None
        try:
            __foreEndListAuth__=wangnianxinxi.__foreEndListAuth__
        except:
            __foreEndListAuth__=None

        #authSeparate
        try:
            __authSeparate__=wangnianxinxi.__authSeparate__
        except:
        ...
        try:
            __authTables__=wangnianxinxi.__authTables__
        except:
            __authTables__=None
        ...
        if wangnianxinxi.__tablename__[:7]=="discuss":
            try:
                del req_dict['userid']
            except:
                pass
        ...
        q = Q()
        msg['data']['list'], msg['data']['currPage'], msg['data']['totalPage'], msg['data']['total'], \
        msg['data']['pageSize']  = wangnianxinxi.page(wangnianxinxi, wangnianxinxi, req_dict, request, q)
        return JsonResponse(msg, encoder=CustomJsonEncoder)

def wangnianxinxi_save(request):
    '''
    后台新增
    '''
    if request.method in ["POST", "GET"]:
        ...
        idOrErr= wangnianxinxi.createbyreq(wangnianxinxi,wangnianxinxi, req_dict)
...
def wangnianxinxi_thumbsup(request,id_):
    '''
    ...
    if request.method in ["POST", "GET"]:
        ...
        rets=wangnianxinxi.getbyid(wangnianxinxi,wangnianxinxi,id_)
        ...
        error = wangnianxinxi.updatebyparams(wangnianxinxi,wangnianxinxi, update_dict)
        if error!=None:
            msg['code'] = crud_error_code
            msg['msg'] = error
        return JsonResponse(msg, encoder=CustomJsonEncoder)
...
def wangnianxinxi_info(request,id_):
    '''
    '''
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}

        data = wangnianxinxi.getbyid(wangnianxinxi,wangnianxinxi, int(id_))
        if len(data)>0:
            msg['data']=data[0]
        ...
        #浏览点击次数
        try:
            __browseClick__= wangnianxinxi.__browseClick__
        except:
            __browseClick__=None

        if __browseClick__=="是"  and  "clicknum"  in wangnianxinxi.getallcolumn(wangnianxinxi,wangnianxinxi):
            try:
                clicknum=int(data[0].get("clicknum",0))+1
            except:
                clicknum=0+1
            click_dict={"id":int(id_),"clicknum":clicknum,"clicktime":datetime.datetime.now()}
            ret=wangnianxinxi.updatebyparams(wangnianxinxi,wangnianxinxi,click_dict)
            if ret!=None:
                msg['code'] = crud_error_code
                msg['msg'] = ret
        return JsonResponse(msg, encoder=CustomJsonEncoder)

def wangnianxinxi_detail(request,id_):
    '''
    '''
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
...
def wangnianxinxi_update(request):
    '''
    '''
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        ...
        if 'clicktime' in req_dict.keys() and req_dict['clicktime']=="None":
            del req_dict['clicktime']
        if req_dict.get("mima") and "mima" not in wangnianxinxi.getallcolumn(wangnianxinxi,wangnianxinxi) :
            del req_dict["mima"]
        if req_dict.get("password") and "password" not in wangnianxinxi.getallcolumn(wangnianxinxi,wangnianxinxi) :
        ...
        error = wangnianxinxi.updatebyparams(wangnianxinxi, wangnianxinxi, req_dict)
        if error!=None:
            msg['code'] = crud_error_code
            msg['msg'] = error
...
def wangnianxinxi_delete(request):
    '''
    批量删除
    '''
    if request.method in ["POST", "GET"]:
        ...
        error=wangnianxinxi.deletes(wangnianxinxi,
            wangnianxinxi,
             req_dict.get("ids")
        )
        if error!=None:
...
def wangnianxinxi_vote(request,id_):
    '''
    ...
    if request.method in ["POST", "GET"]:
        ...
        for i in data:
            ...
            if votenum!=None:
                ...
                error=wangnianxinxi.updatebyparams(wangnianxinxi,wangnianxinxi,params)
                if error!=None:
                    msg['code'] = crud_error_code
                    msg['msg'] = error
        return JsonResponse(msg)

def wangnianxinxi_importExcel(request):
    if request.method in ["POST", "GET"]:
            ...
            try:
                for row in range(1, rows):
                    ...
                    if '.0' in str(row_values[7]):
                        req_dict['jiangshuiliang'] = str(row_values[7]).split('.')[0]
                    elif str(row_values[7]) != '':
                        req_dict['jiangshuiliang'] = row_values[7]
                    else:
                    ...
                    wangnianxinxi.createbyreq(wangnianxinxi, wangnianxinxi, req_dict)
...
def wangnianxinxi_autoSort2(request):
...
def wangnianxinxi_cleanse(request):
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": "成功", "data": {}}
        try:
            list, _, _, total,_ = wangnianxinxi.page(wangnianxinxi, wangnianxinxi, {})
            ...
            wangnianxinxi.deletes(wangnianxinxi,wangnianxinxi,ids=[i["id"] for i in list])
            batchList = []
            for dl in data_list:
                filtered_data = {k: v for k, v in dl.items() if v not in [None, '', float('nan')] and (not isinstance(v, float) or not math.isnan(v))}
                batchList.append(wangnianxinxi(**filtered_data))
            wangnianxinxi.objects.bulk_create(batchList)
        except Exception as e:
            msg["code"] = other_code
            msg["msg"] = e.__str__()
